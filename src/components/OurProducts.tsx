...
const FeaturedProducts: FC = () => {
  const products = [
    ...
    { id: 5, label: "New", name: "Library Stool Chair", price: "$20", originalPrice: "", img: "/images/product-05.png" },
    { id: 6, label: "Sale", name: "Library Stool Chair", price: "$20", originalPrice: "$30", img: "/images/product-08.png" },
    { id: 7, label: "", name: "Library Stool Chair", price: "$20", originalPrice: "", img: "/images/product-09.png" },
    { id: 8, label: "", name: "Library Stool Chair", price: "$20", originalPrice: "", img: "/images/product-01.png" },
  ];
